...
describe('Unliking A Cafe', () => {
  ...
  it('should display unlike widget when the cafe has been liked', async () => {
    ...
    expect(document.querySelector('[aria-label="tidak suka dengan restoran ini"]'))
      .toBeTruthy();
  });
  ...
  it('should not display like widget when the cafe has been liked', async () => {
    ...
    expect(document.querySelector('[aria-label="suka dengan restoran ini"]'))
      .toBeFalsy();
  });
  ...
  it('should be able to remove liked cafe from the list', async () => {
    ...
    document.querySelector('[aria-label="tidak suka dengan restoran ini"]').dispatchEvent(new Event('click'));
